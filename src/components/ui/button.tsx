  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-bold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-accent text-primary-dark font-bold shadow-lg hover:shadow-xl hover:scale-105 active:scale-95",
        heroOutline: "border-2 border-accent text-accent font-bold hover:bg-accent hover:text-primary-dark",
        // Record button
        record: "bg-destructive text-white rounded-full shadow-lg hover:scale-110 active:scale-95",
        recordActive: "bg-destructive text-white rounded-full shadow-[0_0_0_8px_rgba(239,68,68,0.3)] animate-pulse",
        // Success variant
